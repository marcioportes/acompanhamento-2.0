 ...
 * - 1.32.0: arch: Pagina dedicada Mesa Prop (#145) — extrair PropAccountCard/AlertsBanner/PayoutTracker/AiApproachPlanSection do StudentDashboard para PropFirmPage, novo item condicional no Sidebar, ContextBar governa pagina, remover P&L dia stale e sparkline DD sem escala, attack plan e AI approach plan phase-aware (PA/SIM_FUNDED/LIVE), tradingDays derivado de drawdownHistory (fix contagem inflada por imports).
