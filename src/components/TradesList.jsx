...
/**
 * TradesList (Versão Corrigida - Ícones Diretos)
 * Removemos o Dropdown Menu para evitar problemas de corte (overflow).
 */
const TradesList = ({ 
  trades = [], 
  onViewTrade, 
            ...
            return (
              <tr key={trade.id} className="group hover:bg-slate-800/30 transition-colors">
                ...
                <td className="p-4 text-right">
                  <div className={`font-bold ${getResultColor(result)}`}>
                ...
                {/* AÇÕES COM ÍCONES (Resolve o problema do menu escondido) */}
                <td className="p-4 text-right">
