...
import { decodeCsv, headersDoArquivo, TIMEZONE } from '../helpers/brokerReplay';
...
const WIN = { tickSize: 5, tickValue: 1, pointValue: 0.2 };
const ALUNO = 'aluno-1';
const BATCH = 'batch-2409';

// ---------- ordens do arquivo → docs de `orders` ----------

const ordensDoArquivo = (arquivo) => {
 ...
 */
const montarDia = (arquivo, batchId) => {
