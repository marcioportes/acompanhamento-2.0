...
export const BEHAVIORAL_PATTERNS = Object.freeze({
  ...
  // #376 — modelo de operação não declarado. Não é emoção: é processo, por isso
  // `emotionMapping: null`. Dimensão Operacional. Impede CLEAN_EXECUTION: acertar sem
  // saber por quê não é execução limpa.
  UNDECLARED_MODEL: P({
...
/** @see TETO_DE_SEVERIDADE */
export function severidadeVigente(code, severityGravada) {
