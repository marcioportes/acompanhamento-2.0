...
export const GATES_BY_TRANSITION = {
  '1-2': [
    {
      id: 'maxdd-under-20', label: 'MaxDD < 25%',
      friendlyLabel: 'Queda máxima do capital abaixo de 25%', unit: '%',
      ...
      dim: 'fin', metric: 'maxDDPercent', op: '<=', threshold: 25,
    },
    {
      id: 'rule-compliance-80', label: 'Compliance ≥ 60%',
      friendlyLabel: 'Disciplina (regras respeitadas) em 60% dos trades', unit: '%',
      whatIs: 'Quantos trades terminaram dentro das regras pré-definidas (risco máximo, stop).',
      howTo: 'Antes de mandar a ordem, conferir: SL definido? risco dentro do plano? Dois cliques.',
      dim: 'op', metric: 'complianceRate', op: '>=', threshold: 60,
    },
    {
      id: 'emotional-out-of-fragile', label: 'Emocional ≥ 25',
      friendlyLabel: 'Sair da faixa frágil (score emocional ≥ 25)', unit: 'pts',
      whatIs: 'Mede sua resposta emocional ao trading. Abaixo de 25 = frágil, reativo às oscilações.',
      howTo: 'Diário emocional pré-trade. Pausa de 15min após qualquer dia com tilt. Pular trade quando não estiver pronto.',
      dim: 'emo', metric: 'E', op: '>=', threshold: 25,
    },
    {
      id: 'basic-journal', label: 'Journal em 40%+ dos trades',
      friendlyLabel: 'Anotar contexto em pelo menos 40% dos trades', unit: '%',
      ...
      dim: 'op', metric: 'journalRate', op: '>=', threshold: 0.40,
    },
    {
      id: 'stop-usage', label: 'Stop em 60%+ dos trades',
      friendlyLabel: 'Stop-loss definido em 60% dos trades', unit: '%',
      ...
      dim: 'fin', metric: 'stopUsageRate', op: '>=', threshold: 0.60,
    },
    {
      id: 'plan-linked-trades', label: 'Plan-linked ≥ 60%',
      friendlyLabel: 'Pelo menos 60% dos trades atrelados a um plano', unit: '%',
      ...
      dim: 'op', metric: 'planAdherence', op: '>=', threshold: 60,
    },
    {
      id: 'rule-violation-rate-30', label: 'Padrões de risco ≤ 45%',
      friendlyLabel: 'Padrões comportamentais em no máximo 45% dos trades', unit: '%',
      ...
      dim: 'op', metric: 'ruleViolationRate', op: '<=', threshold: 0.45,
    },
  ],
  '2-3': [
    {
      id: 'emotional-55', label: 'Emocional ≥ 45',
      friendlyLabel: 'Score emocional acima da faixa reativa (≥ 45)', unit: 'pts',
      whatIs: 'Acima de 45 você já não reage por impulso na maioria das situações.',
      howTo: 'Manter pausa após losses. Não operar dias em que percebe tilt antes do mercado abrir.',
      dim: 'emo', metric: 'E', op: '>=', threshold: 45,
    },
    {
    ...
    {
      id: 'operational-65', label: 'Operacional ≥ 55',
      friendlyLabel: 'Score operacional médio (≥ 55)', unit: 'pts',
      ...
      dim: 'op', metric: 'O', op: '>=', threshold: 55,
    },
    {
      id: 'strategy-8-weeks', label: '6 semanas sem trocar estratégia',
      friendlyLabel: 'Manter a mesma estratégia por 6 semanas', unit: 'semanas',
      ...
      dim: 'op', metric: 'strategyConsWks', op: '>=', threshold: 6,
    },
    {
      id: 'journal-90', label: 'Journal ≥ 75%',
      friendlyLabel: 'Anotar contexto em 75% dos trades', unit: '%',
      ...
      dim: 'op', metric: 'journalRate', op: '>=', threshold: 0.75,
    },
    {
      id: 'compliance-95', label: 'Compliance ≥ 70%',
      friendlyLabel: 'Disciplina alta (≥ 70% dos trades dentro das regras)', unit: '%',
      whatIs: 'Poucas violações. Mostra que regras são compromisso, não sugestão.',
      howTo: 'Gate na entrada: app barra se o risco passa do limite. Quebrar regra = fechar plataforma.',
      dim: 'op', metric: 'complianceRate', op: '>=', threshold: 70,
    },
    {
      id: 'winrate-45', label: 'Win rate ≥ 40%',
      friendlyLabel: 'Taxa de acerto (vitórias) acima de 40%', unit: '%',
      ...
      dim: 'fin', metric: 'winRate', op: '>=', threshold: 40,
    },
    {
      id: 'payoff-1_2', label: 'Payoff ≥ 1.0',
      friendlyLabel: 'Ganho médio pelo menos igual à perda média', unit: '',
      whatIs: 'Vitória vale R$X, derrota vale R$Y. Payoff = X/Y. A partir de 1,0 os ganhos já cobrem as perdas.',
      howTo: 'Deixar vencedores rodarem até o alvo. Cortar perdedores rápido no SL — não esticar.',
      dim: 'fin', metric: 'payoff', op: '>=', threshold: 1.0,
    },
    {
      id: 'rule-violation-rate-15', label: 'Padrões de risco ≤ 35%',
      friendlyLabel: 'Padrões comportamentais em no máximo 35% dos trades', unit: '%',
      ...
      dim: 'op', metric: 'ruleViolationRate', op: '<=', threshold: 0.35,
    },
  ],
  '3-4': [
    {
      id: 'emotional-75', label: 'Emocional ≥ 65',
      friendlyLabel: 'Score emocional consolidado (≥ 65)', unit: 'pts',
      ...
      dim: 'emo', metric: 'E', op: '>=', threshold: 65,
    },
    {
    ...
    {
      id: 'operational-80', label: 'Operacional ≥ 70',
      friendlyLabel: 'Score operacional alto (≥ 70)', unit: 'pts',
      whatIs: 'Execução praticamente sem ruído — quase tudo dentro do plano.',
      howTo: 'Compliance ≥ 85%, journal alto, no máximo 2 episódios de stop tampering na janela. Execução é ofício, não tentativa.',
    ...
    {
      id: 'compliance-100', label: 'Compliance ≥ 85%',
      friendlyLabel: 'Disciplina muito alta (≥ 85% dos trades dentro das regras)', unit: '%',
      whatIs: 'Disciplina quase total numa janela grande — no máximo lapsos isolados.',
      howTo: 'Gates no app barram entrada fora do plano. Mentor revisa qualquer violação imediatamente.',
      dim: 'op', metric: 'complianceRate100', op: '>=', threshold: 85,
    },
    {
      id: 'winrate-55', label: 'Win rate ≥ 48%',
      friendlyLabel: 'Taxa de acerto acima de 48%', unit: '%',
      whatIs: 'Boa parte dos trades positivos. Sinal de edge, especialmente combinado com payoff alto.',
      howTo: 'Foco em qualidade de setup. Pular dias sem oportunidade clara — não forçar entradas.',
      dim: 'fin', metric: 'winRate', op: '>=', threshold: 48,
    },
    {
      id: 'payoff-2', label: 'Payoff ≥ 1.5',
      friendlyLabel: 'Ganho médio 1,5× maior que perda média', unit: '',
      whatIs: 'Cada R$1 perdido foi compensado por R$1,50 ganho. É a razão que sustenta o resultado no longo prazo.',
      howTo: 'Alvo escalonado (saída parcial). Stop curto na entrada. Trail dinâmico após pegar metade do alvo.',
      dim: 'fin', metric: 'payoff', op: '>=', threshold: 1.5,
    },
    {
      id: 'maxdd-5', label: 'MaxDD < 12%',
      friendlyLabel: 'Queda máxima do capital abaixo de 12%', unit: '%',
      whatIs: 'Capital nunca caiu mais que 12% no período. Margem de segurança pra continuar operando com clareza.',
      howTo: 'Stop diário em 1-2%. Stop do ciclo em 5%. Reduzir size em sequências negativas.',
      dim: 'fin', metric: 'maxDDPercent', op: '<=', threshold: 12,
    },
    {
      id: 'sharpe-1_2', label: 'Sharpe ≥ 0.8',
      friendlyLabel: 'Sharpe mensal acima de 0,8', unit: '',
      whatIs: 'Sharpe mede retorno por unidade de risco. ≥ 0,8 = ganhos consistentes, não dependem de meses de sorte.',
      howTo: 'Reduzir variância: tamanho de posição uniforme, evitar trades fora do setup base, manter rotina.',
      dim: 'fin', metric: 'monthlySharpe', op: '>=', threshold: 0.8,
    },
    ...
    {
      id: 'no-stop-tampering', label: 'No máximo 2 mexidas no stop',
      friendlyLabel: 'Evitar mexer no stop depois de abrir o trade', unit: '',
      ...
      dim: 'op', metric: 'stopTamperingCount', op: '<=', threshold: 2,
    },
    {
      id: 'no-chase', label: 'No máximo 2 chase reentries',
      friendlyLabel: 'Evitar perseguir o preço após sair', unit: '',
      ...
      dim: 'op', metric: 'chaseCount', op: '<=', threshold: 2,
    },
    {
      id: 'disciplined-sizing', label: 'No máximo 2 saídas parciais por desconforto',
      friendlyLabel: 'Evitar reduzir size do stop por desconforto', unit: '',
      ...
      dim: 'op', metric: 'partialStopCount', op: '<=', threshold: 2,
    },
    {
      id: 'rule-violation-rate-5', label: 'Padrões de risco ≤ 20%',
      friendlyLabel: 'Padrões comportamentais em no máximo 20% dos trades', unit: '%',
      ...
      dim: 'op', metric: 'ruleViolationRate', op: '<=', threshold: 0.20,
    },
  ],
  '4-5': [
    {
      id: 'emotional-85', label: 'Emocional ≥ 80 (SAGE)',
      friendlyLabel: 'Score emocional sage (≥ 80)', unit: 'pts',
      ...
      dim: 'emo', metric: 'E', op: '>=', threshold: 80,
    },
    {
    ...
    {
      id: 'payoff-2_5', label: 'Payoff ≥ 2.0',
      friendlyLabel: 'Ganho médio 2× maior que perda média', unit: '',
      whatIs: 'Cada vitória vale 2 derrotas em valor. Pode até ter WR < 50% e ainda ser muito lucrativo.',
    ...
    {
      id: 'winrate-55-stable', label: 'Win rate ≥ 52% estável',
      friendlyLabel: 'Taxa de acerto estável acima de 52%', unit: '%',
      ...
      dim: 'fin', metric: 'winRate', op: '>=', threshold: 52,
    },
    {
      id: 'maxdd-3', label: 'MaxDD < 8%',
      friendlyLabel: 'Queda máxima do capital abaixo de 8%', unit: '%',
      ...
      dim: 'fin', metric: 'maxDDPercent', op: '<=', threshold: 8,
    },
    {
      id: 'cv-low', label: 'CV < 0.8',
      friendlyLabel: 'Variação do resultado diário abaixo de 0,8', unit: '',
      whatIs: 'CV mede dispersão dos retornos mensais. Abaixo de 0,8 = retornos previsíveis, sem meses excepcionais que disfarçam meses ruins.',
      howTo: 'Sizing uniforme. Setup único e refinado. Operação mecânica nos critérios objetivos.',
      dim: 'fin', metric: 'cv', op: '<', threshold: 0.8,
    },
    {
      id: 'zero-tilt-revenge', label: 'No máximo 1 tilt/revenge',
      friendlyLabel: 'Praticamente sem episódios de tilt ou vingança', unit: '',
      ...
      dim: 'emo', metric: 'tiltRevengeCount', op: '<=', threshold: 1,
    },
    {
      id: 'annual-return-15', label: 'Retorno anual ≥ 12%',
      friendlyLabel: 'Retorno anualizado acima de 12%', unit: '%',
      whatIs: 'Retorno por ano calculado da curva real. Acima de 12% supera índices passivos com folga.',
      howTo: 'Sair de ciclos lucrativos preservando ganho — não devolver. Reinvestir com Kelly conservador.',
      dim: 'fin', metric: 'annualizedReturn', op: '>=', threshold: 12,
    },
    {
      id: 'sharpe-1_5', label: 'Sharpe anual ≥ 1.2',
      friendlyLabel: 'Sharpe anualizado acima de 1,2', unit: '',
      whatIs: 'Sharpe ≥ 1,2 = retorno alto pra cada unidade de risco. Hedge fund de respeito tem essa faixa.',
      howTo: 'Sustentar drawdown baixo e retorno consistente simultaneamente. Volatilidade controlada é o caminho.',
      dim: 'fin', metric: 'annualSharpe', op: '>=', threshold: 1.2,
    },
    {
      id: 'rule-violation-rate-1', label: 'Padrões de risco ≤ 10%',
      friendlyLabel: 'Padrões comportamentais em no máximo 10% dos trades', unit: '%',
      ...
      dim: 'op', metric: 'ruleViolationRate', op: '<=', threshold: 0.10,
    },
  ],
};
