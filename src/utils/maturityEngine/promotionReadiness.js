 ...
 * é ato do mentor.
 *
 * ⚠️ ESPELHO em functions/maturity/promotionReadiness.js — MANTER SINCRONIZADO ⚠️
...
export function isReadyForPromotion(maturity) {
...
export function nextStageOf(maturity) {
