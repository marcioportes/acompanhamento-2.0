 ...
 *
 * ⚠️ ESPELHO CJS de src/utils/maturityEngine/computeFinancial.js — MANTER SINCRONIZADO ⚠️
 */
...
function scoreRiscoPorOperacao(trades) {
...
function scoreQuedaContraLimite(maxDrawdown, plans) {
 ...
 * }}
 */
function computeFinancial({ trades, plans, maxDrawdown } = {}) {
