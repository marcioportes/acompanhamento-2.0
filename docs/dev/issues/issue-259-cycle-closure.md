...
- DEC-AUTO-259-14 — Gate `pl ≤ account.currentBalance` aplica-se apenas a `mode === 'create'`. Edição preserva `plan.pl` como capital base histórico imutável; ajustes downstream (cycleGoal/RO) não tocam o capital.
