...
| 1.80.0 | #315 | `feat/issue-315-humanize-evidence` | 01/07/2026 | consumida (PR #322 squash `91f19484`) |
...
| 1.84.0 | #101 | `feat/issue-101-torre-controle` | 27/07/2026 | consumida (PR #411 squash `4ab2c3eb`) |
...
| 1.83.20 | #375 | `fix/issue-375-oco-protection-read` | 21/08/2026 | consumida (PR #379 squash `080ab2d7`) |
...
| 1.89.1 | #427 | `chore/issue-427-harness-visual` | 04/09/2026 | pulada — o harness saiu no mesmo PR do face lift, que é minor |
| 1.90.0 | #427 + #428 | `chore/issue-427-harness-visual` | 06/09/2026 | RESERVADA — harness de render visual + a Torre vira agenda + design system |
