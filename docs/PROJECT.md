...
> **Versão:** 0.23.0  
> **Última atualização:** 20/04/2026 — §4.2 Gate Pré-Entrega reforçado com lições do SEV1 #162: (a) `npm run lint` em arquivos tocados (zero `no-undef`), (b) validação em browser por contexto de consumo (aluno / mentor viewAs / override-embedded). Mudança de protocolo — bump MINOR  
